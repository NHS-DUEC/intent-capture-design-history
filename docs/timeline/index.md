...
layout: content-page
title: Timeline
description: A chronological view of how the AI Intent Capture work has developed.
permalink: /timeline/
---

This timeline records the main shifts in the AI Intent Capture work. It is intended to help new readers understand how the team’s thinking has changed over time.
...
The first design history post established the core problem: people often come to the NHS with a need, worry, symptom or question, but do not necessarily know where that need fits within the NHS.

It also set out early design principles, including that the service should be useful before it is clever, should show its seams, should be safe by design, should work with the NHS and should be inclusive from the start.
...
### Shift from AI Navigation towards Intent Capture

As the work developed, the term AI Navigation began to feel too broad. It described a desired outcome, but not the specific capability being designed.
...
The team explored how to classify intents. This included both a taxonomy of possible intents and a broader behavioural or functional typology.

The distinction matters because a taxonomy helps organise known items, while a typology helps describe patterns of behaviour or purpose across different intents.

### Placement and evaluation thinking

The work began to consider where Intent Capture should appear and how placement options might be assessed.
...
The design history was expanded beyond chronological posts. New sections were added for user needs, decision records, concepts, evidence and roadmap.

This changed the repository from a simple design history into a more complete programme record.
...
A dedicated post was added to explain the shift from AI Navigation to Intent Capture. This records the terminology change as a narrowing and clarification of the design object, rather than as a rejection of earlier thinking.
