...
layout: content-page
title: Concepts
description: Working definitions for the main ideas used in AI Intent Capture.
permalink: /concepts/
---
...
An intent is what a person is trying to do, express, resolve or understand at a particular point in their journey.

An intent may involve a symptom, but it is not the same as a symptom. For example, “I have chest pain” is a symptom expression; “I need to know whether this is an emergency” is closer to an intent.
...
Navigation is helping someone move through the NHS system. It includes signposting, routing, handover and helping people understand where to go next.
...
Intelligent Navigation is broader than Intent Capture. It describes the wider capability to route and coordinate people across services and pathways based on what is known about their need, context and available options.
